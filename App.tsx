...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-jd-dark text-jd-text">
      ...
      {/* Symmetric Modern Sitemap Footer - Enhanced Font Sizes */}
      <footer className="bg-jd-dark border-t border-white/5 pt-24 pb-12">
        <div className="max-w-[1600px] mx-auto px-10">
          <div className="flex flex-col items-center text-center md:grid md:grid-cols-2 lg:grid-cols-4 md:items-start md:text-left gap-16 md:gap-12 mb-20">
            ...
            <div className="flex flex-col items-center md:items-start space-y-10">
              <div className="flex flex-col items-center md:items-start space-y-6">
                <h3 className="text-white font-black text-5xl tracking-tighter uppercase leading-none">
                  JD MORGAN
                </h3>
                <div className="inline-block px-6 py-2.5 border border-jd-gold/30 rounded-sm">
                  <span className="text-jd-gold font-black text-2xl tracking-[0.3em] uppercase leading-none">
                    GLOBAL TRADING
                  </span>
                </div>
                <div className="pt-2">
                  <p className="text-sm text-gray-500 font-black uppercase tracking-[0.3em] leading-relaxed">
                    {t.sitemap_reg}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-10 pt-4">
                 <a href="#" className="text-gray-600 hover:text-jd-gold transition-all text-3xl"><i className="fa-brands fa-linkedin-in"></i></a>
                 <a href="#" className="text-gray-600 hover:text-jd-gold transition-all text-3xl"><i className="fa-brands fa-telegram"></i></a>
              </div>
            </div>

            {/* Column 2: Trade Terminal - Increased font size */}
            <div className="flex flex-col items-center md:items-start space-y-10">
              <h4 className="text-jd-gold text-xl font-black uppercase tracking-[0.5em]">
                 {t.sitemap_platform}
              </h4>
              <div className="flex flex-col items-center md:items-start gap-6 text-lg font-black uppercase tracking-[0.25em]">
            ...
            {/* Column 3: Global Network - Increased font size & Removed Address */}
            <div className="flex flex-col items-center md:items-start space-y-10">
              <h4 className="text-jd-gold text-xl font-black uppercase tracking-[0.5em]">
                 {t.sitemap_network}
              </h4>
            ...
            {/* Column 4: Compliance & Security - Increased font size */}
            <div className="flex flex-col items-center md:items-start space-y-10 w-full max-w-[280px]">
              <div className="flex flex-col items-center md:items-start space-y-10 w-full">
                <h4 className="text-jd-gold text-xl font-black uppercase tracking-[0.5em]">
                   {t.sitemap_legal}
                </h4>
                <div className="flex flex-col items-center md:items-start gap-6 text-lg font-black uppercase tracking-[0.25em]">
          ...
          {/* Centered Fraud Report Button - Enlarged text */}
          <div className="flex justify-center mb-16 animate-in fade-in slide-in-from-bottom-2">
            <button 
              onClick={() => setCurrentView(View.FRAUD_REPORT)} 
              className="w-full max-w-md py-6 border border-jd-gold/40 rounded-xl text-sm font-black text-jd-gold uppercase tracking-[0.4em] hover:bg-jd-gold hover:text-jd-dark transition-all shadow-xl flex items-center justify-center gap-4 group"
            >
              <i className="fa-solid fa-shield-halved group-hover:scale-110 transition-transform text-lg"></i> {t.footer_fraud}
            </button>
          </div>

          {/* Bottom Copyright Bar - Increased font size */}
          <div className="pt-12 border-t border-white/5 text-center">
            <p className="text-sm text-gray-700 font-black uppercase tracking-[0.5em]">
