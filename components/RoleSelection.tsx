...
const RoleSelection: React.FC<RoleSelectionProps> = ({ onSelect }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 pt-20 bg-jd-dark">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl w-full">
        ...
        <div 
          ...
          className="group relative bg-jd-light border border-white/10 hover:border-jd-gold/40 p-12 rounded-[2.5rem] cursor-pointer transition-all duration-500 transform hover:-translate-y-3 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.7)]"
        >
          <div className="absolute top-6 right-8 text-jd-gold/5 group-hover:text-jd-gold/15 transition-colors">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="w-16 h-16 bg-green-500/10 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-green-500/20 transition-colors border border-green-500/20">
