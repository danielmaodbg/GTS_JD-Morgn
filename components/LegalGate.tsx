    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-4xl bg-[#0a1128] border border-jd-gold/30 rounded-[3.5rem] shadow-[0_0_120px_rgba(0,0,0,0.9)] overflow-hidden animate-in fade-in zoom-in duration-500 flex flex-col max-h-[92vh]">
        ...
        <div className="px-10 py-6 flex-grow overflow-hidden flex flex-col">
          ...
          {/* Affirmation Text Box with Large Font (Increased by 50%) */}
          <div className="mt-8 mb-8 border border-blue-500/40 bg-blue-500/5 p-8 rounded-xl flex items-center justify-center">
            <span className="text-gray-400 text-xl md:text-2xl font-bold tracking-[0.1em] text-center">
              條款已閱讀完畢，請點擊下方按鈕確認
            </span>
          </div>
        </div>
